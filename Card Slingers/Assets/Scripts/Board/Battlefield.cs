...
public class Battlefield : MonoBehaviour
{
    ...
    {
        _origin = new Vector3(
            (-Width * CELL_SIZE * 0.5f) + (CELL_SIZE * 0.5f) + transform.position.x, 
            transform.position.y, 
            (-Depth * CELL_SIZE * 0.5f) + (CELL_SIZE * 0.5f) + transform.position.z);
        ...
        CameraController.instance.SetHome(new Vector3(0, 12, -initZ), transform.rotation.y);
    }
